...
<body>
	...
	<div id="navigation">
		...
		<div class="navigation-stub">
		<input id="navigation-search" name="aggregate" placeholder="Food/Restaurant/Place">
		</div>
		<div class="navigation-stub">
		<input type="submit" class="searchButton" value="LOOK FOR RESTOS!">
		</div>
